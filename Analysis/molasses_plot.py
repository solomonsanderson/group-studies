...
ax.plot(time_repump, repump, label="Repump", alpha=1, color="blue"     )
ax.plot(time_ci, mc, label = "MOT Coils", alpha=1, color="red"         )
ax.plot(time_ci, ci, label="Cooling Intensity", alpha=1, color="green" )
ax.set_xlim(-2,23)
